...
<mark style="background: #FFB86CA6;">در سناریوهایی که APIهای شما می‌توانند درخواست‌ها را سریع‌تر از هر سرویس دریافتی throttle شده انجام دهند، بهتر است سرعت استفاده از این سرویس را مدیریت کنید. با این حال، تنها در نظر گرفتن throttling به عنوان یک راه حل برای مشکلاتی که در عدم تطابق نرخ داده‌ها و  بافر یا هدایت کردن درخواست‌ها تا زمانی که سرویس throttled بتواند به آن رسیدگی کند تا حدودی خطرناک است. اگر برنامه شما در این سناریو دچار مشکل شود، خطر از دست دادن هر یک از این داده های بافر یا هدایت شده را دارید.</mark>
