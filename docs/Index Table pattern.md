...
*‏  [Sharding pattern](./Sharding%20pattern.md). الگوی index table اغلب در ارتباط با دادههای تقسیم بندی شده با استفاده از خرده‌ها(shards) استفاده می‌شود. الگوی Sharding اطلاعات بیشتری در مورد نحوه تقسیم یک data store به مجموعه ای از shardها ارائه می‌دهد. 
