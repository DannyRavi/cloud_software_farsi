...
> بسیاری از سیستم‌های پیکربندی داخلی هنگام راه‌اندازی برنامه، داده‌ها را می‌خوانند و داده‌ها را در حافظه پنهان می‌کنند تا دسترسی سریع را فراهم کنند و تأثیر آن بر عملکرد برنامه به حداقل برسد. بسته به نوع ذخیره پشتیبان مورد استفاده و تأخیر این ذخیره، ممکن است پیاده سازی مکانیزم ذخیره سازی در حافظه پیکربندی خارجی مفید باشد. برای اطلاعات بیشتر، راهنمای ذخیره سازی را ببینید. شکل یک نمای کلی از الگوی فروشگاه پیکربندی خارجی با حافظه پنهان محلی اختیاری را نشان می دهد.

![[Pasted image 20231127160212.png]]

## Issues and considerations

هنگام تصمیم گیری در مورد نحوه اجرای این الگو به نکات زیر توجه کنید:

یک فروشگاه پشتیبان را انتخاب کنید که عملکرد قابل قبول، در دسترس بودن بالا، استحکام را ارائه می دهد و می تواند به عنوان بخشی از فرآیند نگهداری و مدیریت برنامه از آن نسخه پشتیبان تهیه کند. در یک برنامه میزبانی ابری، استفاده از مکانیزم ذخیره سازی ابری یا سرویس پلت فرم پیکربندی اختصاصی معمولاً انتخاب خوبی برای برآورده کردن این الزامات است.

طرح واره فروشگاه پشتیبان را طراحی کنید تا امکان انعطاف پذیری در انواع اطلاعاتی را که می تواند نگه دارد. اطمینان حاصل کنید که تمام الزامات پیکربندی مانند داده‌های تایپ‌شده، مجموعه‌ای از تنظیمات، نسخه‌های چندگانه تنظیمات و هر ویژگی دیگری را که برنامه‌هایی که از آن استفاده می‌کنند نیاز دارند را فراهم می‌کند. طرحواره باید برای پشتیبانی از تنظیمات اضافی با تغییر نیازمندی ها آسان باشد.

قابلیت‌های فیزیکی ذخیره‌سازی پشتیبان، نحوه ارتباط آن با نحوه ذخیره اطلاعات پیکربندی و تأثیرات آن بر عملکرد را در نظر بگیرید. به عنوان مثال، ذخیره یک سند XML حاوی اطلاعات پیکربندی به رابط پیکربندی یا برنامه نیاز دارد تا سند را برای خواندن تنظیمات جداگانه تجزیه کند. این به‌روزرسانی تنظیمات را پیچیده‌تر می‌کند، اگرچه ذخیره تنظیمات می‌تواند به جبران عملکرد خواندن کندتر کمک کند.

در نظر بگیرید که چگونه رابط پیکربندی اجازه کنترل دامنه و ارث بر تنظیمات پیکربندی را می دهد. به عنوان مثال، ممکن است نیاز باشد که تنظیمات پیکربندی در سطح سازمان، برنامه و دستگاه انجام شود. ممکن است نیاز باشد که از تفویض کنترل دسترسی به حوزه‌های مختلف پشتیبانی کند و از لغو تنظیمات به برنامه‌های کاربردی جلوگیری کند یا اجازه دهد.
...
* تنظیمات پیکربندی که بین چندین برنامه و نمونه برنامه به اشتراک گذاشته می شود، یا جایی که یک پیکربندی استاندارد باید در چندین برنامه کاربردی و نمونه برنامه اعمال شود.
...
- Learn how to [integrate Azure App Configuration with Kubernetes deployments](https://learn.microsoft.com/en-us/azure/azure-app-configuration/integrate-kubernetes-deployment-helm)
- Learn how Azure App Configuration also can help [manage feature flags](https://learn.microsoft.com/en-us/azure/azure-app-configuration/manage-feature-flags)