...
مراقب سناریو‌هایی باشید که در آن پردازش یک رویداد شامل ایجاد یک یا چند رویداد جدید می‌شود زیرا این امر می‌تواند باعث ایجاد یک حلقه بی نهایت شود.
