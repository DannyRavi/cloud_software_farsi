...
2- مجموعه‌ای حاوی اطلاعات مربوط به تمام رزرو‌های کنفرانس با پرس و جو از رویداد‌هایی که رزروها و لغوها را توصیف می‌کنند ساخته می‌شود. این مجموعه  `SeatAvailability` نامیده می‌شود و در یک  domain model قرار می‌گیرد که روش‌هایی را برای کوئری و اصلاح داده‌ها در مجموعه نشان می‌دهد.
