...
*‏ سیستم‌‌هایی که در آنها به‌روزرسانی‌‌های بی‌درنگ و یکپارچگی زیاد برای داده‌ها مورد نیاز است.  
