یک ذخیره‌گاه داده را به مجموعه ای از پارتیشن های افقی یا خرده(shards) تقسیم کنید. این گزینه می تواند مقیاس پذیری را هنگام ذخیره سازی و دسترسی به حجم زیادی از داده ها بهبود بخشد.
## Context and problem
