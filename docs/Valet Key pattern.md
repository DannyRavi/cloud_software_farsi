...
* زمانی که کلاینت‌ها به طور منظم داده ها را آپلود یا دانلود می کنند، به خصوص در جاهایی که داده‌هایی با حجم زیادی وجود دارد یا زمانی که هر عملیات شامل فایل‌های بزرگی است.
