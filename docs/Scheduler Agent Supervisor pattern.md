...
*‏ [Circuit Breaker pattern](./Circuit%20Breaker%20pattern.md). یک Agent می‌تواند از این الگو برای رسیدگی به خطاهایی استفاده کند که تصحیح آنها زمان متغیری در هنگام اتصال به یک سرویس یا منبع remote نیاز دارد.  
