...
تراکنش باید _atomic_، یکپارچه(_consistent_)، ایزوله(_isolated_) و بادوام(_durable_)  یا به اختصار (ACID) باشد. تراکنش‌‌های درون یک سرویس از نوع ACID هستند، اما یکپارچگی داده‌‌های بین سرویس‌‌های مختلف به یک استراتژی مدیریت تراکنش‌‌های در بین این سرویس‌ها نیاز دارد.
