...
* اعتبار سنجی URL که جستجوی DNS برمی گرداند. با اعتبارسنجی، می توانید از صحیح بودن ورودی ها اطمینان حاصل کنید. همچنین می توانید از تغییر مسیر درخواست های مخربی که ممکن است پس از حمله به سرور DNS شما ایجاد شود، استفاده کنید.
...
* نحوه پیکربندی امنیت برای monitoring endpoint ها را برنامه ریزی کنید. با پیکربندی امنیت، می‌توانید به محافظت از endpointها در برابر دسترسی عمومی برنامه کمک کنید، که ممکن است:  
