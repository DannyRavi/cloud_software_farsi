...
تنوع زیاد سیستمها و دستگاه‌ها در طبقه فروشگاه (shop floor) می‌تواند پیکربندی workload را به یک مشکل دشوار تبدیل کند. این مقاله روش هایی برای حل آن ارائه می‌دهد.
