...
اگر انتظار دارید سرویس‌ها را مرتباً به‌روزرسانی یا جایگزین کنید و در ن‌هایت برخی از سرویس‌ها را اضافه یا حذف کنید، از الگوی choreography استفاده کنید. کل برنامه را می‌توان با تلاش کمتر و حداقل اختلال در سرویس‌‌های موجود تغییر داد.  
