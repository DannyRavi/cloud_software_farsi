از نشانه ای استفاده کنید که دسترسی مستقیم محدودی به یک منبع خاص را برای مشتریان فراهم می کند تا انتقال داده را از برنامه تخلیه کنند. این به ویژه در برنامه‌هایی که از سیستم‌های ذخیره‌سازی میزبان ابری یا صف‌ها استفاده می‌کنند مفید است و می‌تواند هزینه را به حداقل برساند و مقیاس‌پذیری و عملکرد را به حداکثر برساند.
