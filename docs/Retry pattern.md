...
* الگوی [Reliable web app](https://learn.microsoft.com/en-us/azure/architecture/web-apps/guides/reliable-web-app/overview) به شما نشان می‌دهد که چگونه الگوی retry را برای برنامههای تحت وب که در فضای ابری همگرا هستند اعمال کنید.
