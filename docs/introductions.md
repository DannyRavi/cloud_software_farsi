...
نرم افزار متشکل از پایگاه داده و ماژول‌هایی است که به طور خاص به نیاز‌های منحصر به فردی یا سازمان‌های بزرگ در مورد اتوماسیون سیستم تجاری در سطح شرکت و کارایی آن‌ها پاسخ می‌دهند.
...
این مکالمه در مورد کوچک‌سازی در مقابل افزایش مقیاس بر روی روش‌‌هایی تمرکز می‌کند که مقیاس‌پذیری به ما کمک می‌کند تا حجم بسیار زیاد و مجموعه وسیعی از داده‌ها، تغییر حجم داده‌ها و تغییر الگو‌های بار کاری را تطبیق داده و مدیریت کنیم - همه از ابر، تلفن همراه، رسانه‌‌های اجتماعی، و اطلاعات بزرگ.